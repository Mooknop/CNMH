// Minion HP write-back unit tests (#362 stretch) — app↔Foundry for companion/
// familiar HP. Links are ownership-derived (getMinionActorLinks), so the world
// mirrors minionActors.test.js: a PC, her familiar, and her companion.
...
function makeWorld({ zeviraHp = {}, lazarusHp = {}, zeviraTokens = [] } = {}) {
  ...
  const lazarus = makeActor({
    ...
    hasPlayerOwner: true, ownership: OWNED, hp: lazarusHp,
  });
