...
// QuestTracker reads quests + reputation via useContent(); mock the context
// directly rather than the bundled data module.
...
vi.mock('../components/shared/ReputationModal', () => ({ default: ({ isOpen }) =>
  isOpen ? <div data-testid="reputation-modal" /> : null
}));

vi.mock('../components/shared/ReputationRadarChart', () => ({ default: () => (
