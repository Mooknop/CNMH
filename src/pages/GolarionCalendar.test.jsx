...
vi.mock('../components/calendar/MoonPhase', () => {
  const MoonPhase = () => <div data-testid="moon-phase" />;
  const MoonPhaseIndicator = () => <div data-testid="moon-phase-indicator" />;
  MoonPhase.MoonPhaseIndicator = MoonPhaseIndicator;
  return { default: MoonPhase, MoonPhaseIndicator };
});
