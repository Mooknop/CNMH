...
const renderCard = (item, onClick = jest.fn()) => render(<ItemCard item={item} onClick={onClick} />);
...
describe('ItemCard', () => {
  ...
  it('shows a quantity chip only when quantity > 1', () => {
    ...
    rerender(<ItemCard item={{ uid: 'u1', name: 'Arrow', weight: 0, quantity: 1 }} onClick={jest.fn()} />);
