...
describe('SkillPrompt — stale VP challenge payloads', () => {
  // VP challenges derive from cnmh_vpchallenge_global in ChallengePrompts
  // (#1470); a leftover challenge payload on this channel renders nothing.
  it('ignores prompts carrying a challengeId', () => {
    setup();
    act(() => setPrompt({
      reqId: 'vpc-1-thorn',
      challengeId: 'vpc-1',
