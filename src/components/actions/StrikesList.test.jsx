...
vi.mock('../shared/CollapsibleCard', () => ({ default: ({ header, headerRight, children, className }) => (
...
vi.mock('./ThaumaturgeImplementsDisplay', () => ({ default: ({ thaumaturge, themeColor }) => (
...
describe('StrikesList', () => {
  ...
  describe('encounterMode', () => {
    ...
    it('shows no Use button without encounterMode', () => {
      ...
      render(<StrikesList character={char} themeColor="#f00" encounterMode={false} onUse={vi.fn()} />);
