...
const MoonPhase = ({ date, compact = false, showDetails = true }) => {
  const { getCurrentSeason, formatGameDate, getMoonPhaseInfo } = useGameDate();
  ...
  return (
    <div className="moon-phase-display current-date-indicator">
      <div className="moon-header">
        <span className="moon-symbol-large">{moonInfo.symbol}</span>
        <div className="moon-info">
          <h2><span>{formatGameDate()}</span> - <strong>{getCurrentSeason()}</strong></h2>
