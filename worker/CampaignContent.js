...
const COLLECTIONS = ['quest', 'faction', 'calendar', 'lore', 'trait', 'character', 'item', 'spell', 'effect', 'rune', 'fxAnimations', 'image', 'theme', 'monster', 'room', 'event', 'research'];
...
// text must never live in the committed seed. `research` is the GMG Research
// Topics collection (#1839, epic #206): tier text is verbatim Paizo adventure
// prose, same reasoning. The seed pipeline must never manage any of them: a
// force reseed ships these as empty arrays, and the destructive force path
// would wipe every captured/imported doc. They are exempt from ALL seed modes
// here (#760).
const CAPTURE_ONLY = ['monster', 'room', 'event', 'research'];
